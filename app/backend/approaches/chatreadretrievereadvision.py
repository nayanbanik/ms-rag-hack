...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an intelligent assistant aiding researchers with questions about Retrieval-Augmented Generation (RAG) based on academic papers. The documents may include text, graphs, tables, and images.
        Each image source may has the file name in the top left corner of the image with coordinates (10,10) pixels and is in the format SourceFileName:<file_name>
