...
const Chat = () => {
    ...
    const [useOidSecurityFilter, setUseOidSecurityFilter] = useState<boolean>(true);
    const [useGroupsSecurityFilter, setUseGroupsSecurityFilter] = useState<boolean>(true);
    ...
    let [fl, setFl] = useState<File | null>(null);
    ...
    const makeApiRequest = async (question: string, fl: File | null = null) => {
        ...
        if (fl) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setimg(result.message); // Update state instead of local variable
                    question =
                        "Based on the user query: '" +
                        question +
                        "', and the following image inference: '" +
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>RAG Scholar - Your Guide to Understanding RAG</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask anything about RAG or try an example</h2>
                    ...
                    <div className={styles.chatInput}>
                        <div className={styles.inputWithButton}>
                            ...
                            />
                            <label htmlFor="fileInput" className={styles.inputButton}>
                                Image
                            </label>
                            <QuestionInput
                                clearOnSend
                                placeholder="Type a new question (e.g. How to implement RAG?)"
                                disabled={isLoading}
                                onSend={question => makeApiRequest(question, fl)}
